...
<t:wrapper-top>
    ...
    <jsp:attribute name="navbar">
        ...
        <li><a href="#" onclick="window.location.reload(true);"><b>Alterar estado de tarefa</b></a></li>
...
<div class="main-content">
    ...
    <form method="post" action="/ScruManager/gerenciar_projeto/alterar_estado.jsp">

        <div align="center" class="form-horizontal">

            <div class="form-title-row">

                <h2>Tarefa - Alterar estado</h2>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="taskName" name="taskname" readonly="true" value='<%= rs.getString("taskName")%>'>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2 col-sm-offset-2" for="taskDescription">Descrição</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="taskDescription" name="taskdescription" readonly="true" value='<%= rs.getString("taskDescription")%>'>
                </div>
            </div>
        <br/><br/><br/>
            <div class="form-group">
                <label class="control-label col-sm-2 col-sm-offset-2" for="taskstatus">Estado</label>
                <div class="col-sm-4">
                    <select class="form-control" id="taskstatus" name="taskstatus">
                      <option selected disabled hidden>Escolha novo estado</option>
            ...
            <div class="form-group-row">
                <input type="submit" value="Definir novo estado"/>
